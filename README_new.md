...
3. **技能展示(Skills)** - 展示技术栈和专业技能，带有3D旋转立方体
4. **项目展示(Projects)** - 展示个人项目经历，带有3D翻转卡片效果
5. **获奖经历(Awards)** - 展示个人获奖情况，带有精美的奖项轮播展示
...
2. **技能展示的3D立方体** - 技能以3D立方体形式展示，支持自动旋转
3. **项目卡片的3D翻转效果** - 点击项目卡片可以看到卡片的3D翻转效果，展示更多详情
4. **鼠标跟随效果** - 鼠标指针周围有光晕效果，增强交互感
5. **奖项轮播展示** - 使用3D视觉效果的轮播组件展示荣誉奖项，支持自动轮播和手动切换
...
- `components/3d/SkillCube.tsx` - 修改技能展示的3D立方体效果
