              ...
              <CardContent className="p-6 h-full flex flex-col">
                ...
                <div className="space-y-6 flex-grow">
                  <div className="border-l-2 border-primary pl-4 py-1">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm">发表SCI二区文章一篇：<a href="http." className="text-primary hover:text-primary/80">https://www.sciencedirect.com/science/article/pii/S0263224125005731</a></p>
                  </div>
                  <div className="border-l-2 border-primary pl-4 py-1">
                    <div className="flex justify-between">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm">自动化</p>
