...
export function MessageCard({ name, content, email, colorVariant = 'blue', isCompact = false, id, onClick }: MessageCardProps) {
  ...
  return (
    <div 
      className={cn(
        "rounded-2xl border border-gray-200 p-5 shadow-sm mx-2 min-w-[280px] max-w-[340px] overflow-hidden bg-white hover:border-gray-300",
        isCompact ? "my-1" : "my-2",
    ...
    >
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <div className={cn(
            "w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-base shadow-md ring-2 ring-white",
          ...
          <div>
            ...
            {email && (
              <p className="text-xs text-gray-500 flex items-center gap-1 truncate max-w-[200px] mt-0.5">
        ...
        <p className={cn(
          "text-gray-700 line-clamp-3 min-h-[48px] leading-relaxed"
        )}>
          {content}
        </p>
      </div>
